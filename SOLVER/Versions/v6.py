...
# Updated on: 23/05/2023_3:50
# Added History, allows saving to given directory

import os,datetime as datetime
import math, json
...
def soln_parser(s):
	s=s.replace('\/`','√').replace('*',' × ').replace('e^', '𝓮^').replace('x','𝓍').replace('f','𝓯').replace('y','𝓎')
