...
# Updated on: 18/05/2023_01:05
'''		
The solve_differential_equation() function is added. It prompts the user to enter a differential equation of the form "dy/dx = f(x, y)" , 
and then solves it using odeint from the scipy.integrate module. The solution is plotted using matplotlib. 
To use the differential equation solver, select option 'd' from the main menu. Enter the differential equation, initial conditions, and the range of x values to plot.	
'''
